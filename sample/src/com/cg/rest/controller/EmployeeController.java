...
import com.cg.rest.bean.Employee;
import com.cg.rest.bean.EmployeeList;
import com.cg.rest.ds.EmployeeDS;
...
public class EmployeeController {
	...
	public ModelAndView getEmployee(@PathVariable String id) {
		Employee employee = employeeDS.get(Long.parseLong(id));
